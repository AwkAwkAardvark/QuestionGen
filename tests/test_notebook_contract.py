...
class NotebookContractTests(unittest.TestCase):
    def test_runner_ui_validates_runtime_dependencies_before_app_launch(self) -> None:
        ...
        self.assertIn("Stopped after dependency bootstrap to avoid same-kernel import state drift.", source)
        self.assertIn("Set BOOTSTRAP_ENV=False and rerun this setup cell", source)
